            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <img src="<?php base_url() ?>public/NiceAdmin/assets/img/profile-img.jpg" alt="Profile"
                            class="rounded-circle">
                        <h2><?= $this->session->userdata('nama_lengkap') ?></h2>
                        <h3><?= $this->session->userdata('level') ?></h3>
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8"><?= $this->session->userdata('level') ?></div>
                                </div>
                                ...
                                <form>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <img src="<?php base_url() ?>public/NiceAdmin/assets/img/profile-img.jpg"
                                                alt="Profile">
                                            <div class="pt-2">
